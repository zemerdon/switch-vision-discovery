...
# v2.3.14 Hub header / calibration-profile layout regression
...
grep -q 'SWITCH_VISION_DISCOVERY_VERSION="2.3.14"' "$BASE_DIR/discovery_job.sh"
grep -q 'SWITCH_VISION_DISCOVERY_VERSION="2.3.14"' "$BASE_DIR/run.sh"
