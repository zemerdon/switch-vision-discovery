...
def main() -> None:
    with tempfile.TemporaryDirectory(prefix="sv-crs328-telemetry-") as td:
        ...
        lines.extend([
            ...
            '.1.3.6.1.4.1.14988.1.1.3.100.1.2.18 = STRING: "poe-out-consumption"',
            '.1.3.6.1.4.1.14988.1.1.3.100.1.3.18 = INTEGER: 17',
            '.1.3.6.1.4.1.14988.1.1.3.100.1.4.18 = INTEGER: 5',
