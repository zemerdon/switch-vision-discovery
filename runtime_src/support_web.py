...
<label class="field"><span><b>MQTT password</b></span><input id="unifi_mqtt_password" type="password" maxlength="4096" autocomplete="new-password" placeholder="Leave blank to keep the current password" title="Optional MQTT password. Stored passwords are never returned to the Hub."><small id="unifiMqttPasswordState">Not configured</small></label>
...
<p id="unifiSettingsStatus" class="muted">Secrets are never read back into this page. Blank API-key and password fields preserve stored values.</p>
</div>
</section>
