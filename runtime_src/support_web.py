...
'Slow blink period (ms)':'Controls the visual cadence for Slow activity. Allowed range: 120–2000 ms. Lower values make light-traffic flicker more frequent; higher values make it calmer. The Sample preview uses only the last successfully saved value.',
'Medium blink period (ms)':'Controls the visual cadence for Medium activity. Allowed range: 120–2000 ms. Lower values make the activity flicker more frequently. The Sample preview uses only the last successfully saved value.',
'Fast blink period (ms)':'Controls the visual cadence for Fast activity. Allowed range: 120–2000 ms. Lower values produce the most rapid activity flicker. The Sample preview uses only the last successfully saved value.',
