...
<section id="creditsCard" class="card hidden">
<h2>Credits</h2>
<p>Thank you to all the following contributors who have helped make this integration what it is today. Without you all, it would not be possible.</p>
<div id="creditsList" class="device-card"><p class="muted">Contributor acknowledgements will appear here when an approved public name or alias is added.</p></div>
</section>
