...
#creditsCard::before{content:"";position:absolute;inset:-45%;z-index:-3;background:conic-gradient(from 0deg,transparent 0 38%,rgba(54,209,255,.02) 44%,rgba(74,226,255,.85) 49%,rgba(148,242,255,.25) 53%,transparent 59% 100%);opacity:0;animation:credits-edge-orbit 7s linear infinite;pointer-events:none}
...
<div class="credits-energy" aria-hidden="true"></div>
<div class="credits-content">
<h2 class="credits-title">Credits</h2>
<p class="credits-thanks">Thank you to all the following contributors who have helped make this integration what it is today. Without you all, it would not be possible.</p>
<div class="credits-test-badge">TEST ENTRIES — NOT REAL CONTRIBUTORS</div>
<div id="creditsList" class="device-card">
