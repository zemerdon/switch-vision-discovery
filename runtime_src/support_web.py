...
def _diagnostics_snapshot(version: str) -> dict[str, Any]:
    ...
    for cap_path in capability_files:
        ...
        source_switch_name = source_walk.parent.name if str(source_walk) else ""
