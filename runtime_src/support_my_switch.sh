...
# Automatic post-Discovery capture supplies authoritative values. A manual
# Support My Switch capture must never invent success/verified when no current
# run context was supplied.
DISCOVERY_RESULT="${SUPPORT_DISCOVERY_RESULT:-unknown}"
SNMP2MQTT_HANDOFF="${SUPPORT_SNMP2MQTT_HANDOFF:-unknown}"
