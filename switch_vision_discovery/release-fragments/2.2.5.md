...
- Add permanent regressions for manual-target mode, successful and failed post-restart activation verification, delayed MQTT publication, safe retirement ordering, same-run walk freshness, old-walk staleness, and malformed run metadata fallback.
