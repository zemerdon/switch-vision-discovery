...
jq -e '
  ...
  (dev("US XG 16") | .status == "experimental" and .dashboard_support == true and .calibration_profile == "unifi_4_rj45_12sfp" and .default_faceplate == "faceplates/unifi-4-rj45-12sfp.png" and .ports.rj45 == 4 and .ports.ten_gigabit_sfp_plus == 12) and
