...
def _page_with_ui_preferences() -> str:
    """Apply the current UI preference classes and explicit body font size."""
...
<style>
:root{color-scheme:dark;--accent:#2196f3;--accent-strong:#2f83bd;--accent-dark:#0f4f7d;--accent-dark-hover:#146698;--accent-soft:rgba(33,150,243,.12);--page:#071525;--card:#0b1d31;--card-strong:#0e233b;--surface-input:#08192b;--surface-button:#0a1a2c;--surface-inset:#091a2d;--surface-hover:#102a44;--muted:#9bb0c7;--line:#214766;--line-soft:#183750;--warn:#ffb74d;--warn-soft:rgba(255,183,77,.12);--ok:#45d483;--ok-soft:rgba(69,212,131,.15);--bad:#ff6b6b;--bad-soft:rgba(255,107,107,.13);--neutral-soft:rgba(119,128,138,.15);--text:#edf5fc;--on-accent:#fff;--on-primary:#fff;--shadow:rgba(0,0,0,.12);--status-bg:rgba(0,0,0,.12);--code-bg:rgba(0,0,0,.18);--chip-bg:rgba(255,255,255,.03);--chip-hover:rgba(255,255,255,.06);--heading:#69c8ff;--heading-strong:#a6e3ff;--heading-line:#2787c7;--heading-soft:rgba(105,200,255,.09);--heading-glow:rgba(33,150,243,.20);--heart:#ff6ea9;--sv-font-body:16px;--sv-font-page-title:max(18px,1.8em);--sv-font-section-title:max(14px,1.22em);--sv-font-small:max(10px,.86em);--sv-line-height:1.42;--control-height:38px;--control-radius:8px;--control-pad-x:10px;--control-pad-y:6px}
...
<details id="hubComponent-core" class="hub-component"><summary>Switch Vision Core</summary><div class="actions"><button id="hubCoreFallback" type="button">Native HA fallback</button><button id="hubCoreReset" class="danger" type="button">Reset Core defaults</button></div><div id="hubCoreSettings"></div></details>
