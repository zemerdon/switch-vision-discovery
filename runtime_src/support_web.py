...
.topbar-tools{display:flex;align-items:center;justify-content:flex-end;gap:8px;flex-wrap:wrap}.theme-picker{display:flex;align-items:center;gap:7px;height:36px;padding:0 0 0 10px;border:1px solid var(--line-soft);border-radius:9px;background:var(--surface-button);color:var(--muted);font-size:var(--sv-font-small);font-weight:700;white-space:nowrap}.theme-picker select{height:34px;min-width:150px;margin:-1px -1px -1px 0;padding:7px 10px;border-radius:0 9px 9px 0;border-color:var(--line-soft);background:var(--surface-input);color:var(--text);font-weight:600}.theme-picker select:focus-visible{border-color:var(--accent);outline:none}.topbar-theme-label{pointer-events:none}.topbar-lead{flex:1;min-width:220px;margin:0;color:var(--muted);font-size:var(--sv-font-small);line-height:1.35}@media(max-width:760px){.topbar{flex-wrap:wrap}.topbar h1{min-width:180px}.topbar-lead{order:3;flex-basis:100%;min-width:0}.topbar-tools{margin-left:auto}.theme-picker select{min-width:132px}}
...
<section id="calibrationProfilesCard" class="hidden hub-profiles-page">
