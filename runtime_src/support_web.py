...
<button id="devicesTab-overview" class="hub-settings-tab is-active" type="button" role="tab" aria-selected="true" aria-controls="devicesPanel-overview" data-devices-tab="overview">Device Overview</button>
<button id="devicesTab-configure" class="hub-settings-tab" type="button" role="tab" aria-selected="false" aria-controls="devicesPanel-configure" data-devices-tab="configure">Configure Devices</button>
</div>
<section id="devicesPanel-overview" role="tabpanel" aria-labelledby="devicesTab-overview">
<h3>Switches</h3>
...
<section id="devicesPanel-configure" role="tabpanel" aria-labelledby="devicesTab-configure" hidden>
...
async function loadDevices(){setView('devices');window.SwitchVisionHubSettings?.selectDevicesTab?.('overview');await Promise.all([refreshConfiguredDevices(true),refreshDevicesData()])}
...
if(!discoverySwitchExpansionInitialized){if(switches.length)expandedDiscoverySwitches.add(String(switches[0].original_switch_name||switches[0].switch_name||'index:0'));discoverySwitchExpansionInitialized=true}
